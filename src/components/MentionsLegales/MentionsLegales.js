...
function MentionsLegales() {
  return (
    ...
    <section>
      <p>
        Identification du propriétaire du site : Ce site est édité par Kyllian GOULOUMES, Christian HUMBERT, Sofiane KENOUNE et Gauthier LOBEAU.
      </p>
      <p>
        ...
        exclusive de WriterTalent.
        ou de ses partenaires. Toute reproduction, modification, distribution ou
        exploitation de ces contenus sans autorisation écrite préalable est
      ...
      <p>
        ...
        Cependant, les éditeurs de WriterTalent ne peuvent être tenus responsables des erreurs ou omissions dans ces
        informations. De même, les éditeurs de WriterTalent ne peuvent être tenus responsables des dommages directs ou indirects
        résultant de l’utilisation du site ou des informations qu’il contient.
      </p>
      <p>
