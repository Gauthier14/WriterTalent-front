...
export const GET_ALL_SAVED_USER_POSTS_FROM_API = 'GET_ALL_SAVED_USER_POSTS_FROM_API';
export const SET_ALL_SAVED_USER_POSTS_IN_STATE = 'SET_ALL_SAVED_USER_POSTS_IN_STATE';

export const GET_ALL_USER_PUBLISHED_POSTS_FROM_API = 'GET_ALL_USER_PUBLISHED_POSTS_FROM_API';
export const SET_ALL_USER_PUBLISHED_POSTS_IN_STATE = 'SET_ALL_USER_PUBLISHED_POSTS_IN_STATE';

export const GET_ALL_READ_LATER_USER_POSTS_FROM_API = 'GET_READ_LATER__ALL_POSTS_FROM_API';
export const SET_ALL_READ_LATER_USER_POSTS_IN_STATE = 'SET_ALL_READ_LATER_USER_POSTS_IN_STATE';

export const GET_ALL_FAVORITE_USER_POSTS_FROM_API = 'GET_ALL_FAVORITE_USER_POSTS_FROM_API';
export const SET_ALL_FAVORITE_USER_POSTS_IN_STATE = 'SET_ALL_FAVORITE_USER_POSTS_IN_STATE';

export const REMOVE_USER_POST = 'REMOVE_USER_POST';

export const GET_ALL_AWAITING_USER_POSTS_FROM_API = 'GET_ALL_AWAITING_USER_POSTS_FROM_API';
export const SET_ALL_AWAITING_USER_POSTS_IN_STATE = 'SET_ALL_AWAITING_USER_POSTS_IN_STATE';

// actions for all users
export const GET_ALL_MOST_LIKED_POSTS_FROM_API = 'GET_ALL_MOST_LIKED_POSTS_FROM_API';
export const SET_ALL_MOST_LIKED_POSTS_IN_STATE = 'SET_ALL_MOST_LIKED_POSTS_IN_STATE';
...
export const SET_ALL_POSTS_PER_GENRE_IN_STATE = 'SET_ALL_POSTS_PER_GENRE_IN_STATE';
export const SET_ALL_POSTS_PER_CATEGORY_IN_STATE = 'SET_ALL_POSTS_PER_CATEGORY_IN_STATE';

export const GET_READ_POST_FROM_API = 'GET_READ_POST_FROM_API';
export const SET_READ_POST_IN_STATE = 'SET_READ_POST_IN_STATE';

export const GET_INFOS_READ_POST_STATUS = 'GET_INFOS_READ_POST_STATUS';
export const SET_INFOS_READ_POST_STATUS = 'SET_INFOS_READ_POST_STATUS';

export const SET_POST_LOADED = 'SET_POST_LOADED';

export const GET_NUMBER_OF_PUBLISHED_POSTS_AUTHOR = 'GET_NUMBER_OF_PUBLISHED_POSTS_AUTHOR';
export const SET_NUMBER_OF_PUBLISHED_POSTS_AUTHOR_IN_STATE =
  'SET_NUMBER_OF_PUBLISHED_POSTS_AUTHOR_IN_STATE';
export const INCREMENT_POST_NB_VIEWS = 'INCREMENT_POST_NB_VIEWS';
...
// actions for recent posts
export const removeUserPost = (postId, postList) => ({
...
// actions for random post
export const incrementPostNbViews = (postId) => ({
  type: INCREMENT_POST_NB_VIEWS,
  postId: postId,
});
 ...
 */
export const setRandomPostInState = (random) => ({
...
// actions for one post
export const getInfosPostToReadFromApi = (postId) => ({
  type: GET_INFOS_READ_POST_STATUS,
  postId: postId,
});
 ...
 * @param {Object} Posts - Post generated by random method
 */
export const setInfosPostToReadInState = (readPostStatusInfos) => ({
  type: SET_INFOS_READ_POST_STATUS,
  readPostStatusInfos: readPostStatusInfos,
});
