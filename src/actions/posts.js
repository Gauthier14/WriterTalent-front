...
// --- action creators ---
/**
 * @param {number} Posts - List of all user posts
 */
export const getAllUserPostsFromApi = (userId) => ({
  type: GET_ALL_USER_POSTS_FROM_API,
  userId: userId,
});
 ...
 */
export const SetAllUserPostsInState = (postList) => ({
  type: SET_ALL_USER_POSTS_IN_STATE,
  posts: postList,
});
